...
Cleaned the data, checked for nulls and duplicates, then did a risk segmentation analysis nd breaking applicants into groups by credit score to see how approval rates changed.
